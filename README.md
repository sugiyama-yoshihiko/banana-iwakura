...
## 確認済みの方針（2026-09-16 時点）

| 項目 | 決定 |
|---|---|
| 名前の由来（下市場57-1＝ばなな説） | **掲載しない**。裏取りを見送ったため本文に出さない |
| 代表メールアドレス | **設けない**。問い合わせは Instagram の DM のみ |
| 開室時間の表記 | **現状のまま**（「イベント開催時のみ」） |
| 陶芸部の写真（杉山仁彦氏のポートフォリオより） | **掲載許諾あり** |
| NEWS の他アカウント由来の写真 | **掲載許諾あり**（@yohibino / @hazi_iwakura / @catcher_of_cats / @slowartcenternagoya / 市民ギャラリー栄） |
